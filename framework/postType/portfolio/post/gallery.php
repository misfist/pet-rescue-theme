		...
		echo '<div class="project_sidebar">';
			...
			if ($project_details == 'true') {
				echo '<div class="project_details entry-meta">' . 
					...
					cmsms_project_features('details', $cmsms_project_features, false, 'h3', true);
			...
			cmsms_project_features('features', $cmsms_project_features_one, $cmsms_project_features_one_title, 'h3', true);
			
			cmsms_project_features('features', $cmsms_project_features_two, $cmsms_project_features_two_title, 'h3', true);
			
			cmsms_project_features('features', $cmsms_project_features_three, $cmsms_project_features_three_title, 'h3', true);
			
			
			if ($cmsms_project_sharing_box == 'true') {
				cmsms_sharing_box(esc_html__('Like this project?', 'pet-rescue'), 'h3');
			}
