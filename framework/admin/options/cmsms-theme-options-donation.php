...
function get_custom_donation_meta_fields() {
	...
	$tabs_array['cmsms_donation'] = array( 
		'label' => esc_html__('Donation', 'pet-rescue'), 
		'value'	=> 'cmsms_donation' 
	);


	$tabs_array['cmsms_donator'] = array( 
		'label' => esc_html__('Donator', 'pet-rescue'), 
		'value'	=> 'cmsms_donator' 
	);
	...
	$custom_donation_meta_fields = array( 
		...
		array( 
			'label'	=> __('Amount', 'pet-rescue'), 
			'desc'	=> __('do not add currency symbol', 'pet-rescue'), 
		...
		array( 
			'label'	=> __('Recurrence', 'pet-rescue'), 
			'desc'	=> __('Choose whether and how often you want to repeat this donation', 'pet-rescue'), 
			...
			'options' => array( 
				'1' => array( 
					'label' => __('Not recurring', 'pet-rescue'), 
					'value'	=> '1' 
				), 
				'7' => array( 
					'label' => __('Weekly', 'pet-rescue'), 
					'value'	=> '7' 
				), 
				'30' => array( 
					'label' => __('Monthly', 'pet-rescue'), 
					'value'	=> '30' 
				), 
				'365' => array( 
					'label' => __('Yearly', 'pet-rescue'), 
					'value'	=> '365' 
				) 
			) 
		), 
		array( 
			'label'	=> __('Campaign', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Hide Donator Information?', 'pet-rescue'), 
			'desc'	=> __('Yes', 'pet-rescue'), 
		...
		array( 
			'label'	=> __('First Name', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('State / Province', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Postal / Zip Code', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Phone Number', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('About Donator Box', 'pet-rescue'), 
			'desc'	=> __('Show', 'pet-rescue'), 
...
function cmsms_get_donation_campaigns() {
	...
	$array[''] = array( 
		'label' => 	__('No special campaign', 'pet-rescue'), 
		'value' => 	'' 
	);
