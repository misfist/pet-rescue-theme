...
function get_custom_project_meta_fields() {
	...
	$cmsms_global_portfolio_project_details_title = (isset($cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title']) && $cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title'] !== '') ? $cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title'] : __('Project details', 'pet-rescue');
	...
	$tabs_array['cmsms_project'] = array( 
		'label' => esc_html__('Project', 'pet-rescue'), 
		'value'	=> 'cmsms_project' 
	);
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> __('Project Images', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Number of Columns', 'pet-rescue'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => __('Three', 'pet-rescue'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => __('Two', 'pet-rescue'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => __('One', 'pet-rescue'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> __('Project Title', 'pet-rescue'), 
		...
		array( 
			'label'	=> __('Project Size', 'pet-rescue'), 
			'desc'	=> __('Recomended Featured Image dimensions', 'pet-rescue') . ' - ', 
		...
		array( 
			'label'	=> __('Project Details Title', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Info', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __("Project Link Text", 'pet-rescue'), 
			'desc'	=> '', 
			'id'	=> $cmsms_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> __('View Project', 'pet-rescue') 
		), 
		array( 
			'label'	=> __("Project Link URL", 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> __('Redirect to project link URL instead of opening project page', 'pet-rescue'), 
		...
		array( 
			'label'	=> __("Project Link Target", 'pet-rescue'), 
			'desc'	=> __('Open link in a new tab', 'pet-rescue'), 
		...
		array( 
			'label'	=> __('Project Features 1 Title', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 1', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 2 Title', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 2', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 3 Title', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 3', 'pet-rescue'), 
			'desc'	=> '', 
		...
		array( 
			...
			'options' => array( 
				'related' => array( 
					'label' => __('Show Related Tab', 'pet-rescue'),
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => __('Show Popular Tab', 'pet-rescue'),
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => __('Show Recent Tab', 'pet-rescue'),
					'value'	=> 'recent' 
				) 
			) 
		), 
