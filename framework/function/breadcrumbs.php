...
function breadcrumbs() {
	...
	$homeText = esc_attr__('Home', 'pet-rescue');
	...
	echo '<a href="' . esc_url($homeLink) . '" class="cms_home">' . $homeText . '</a>' . $sep;
	...
	if (is_single()) {
		...
		echo '<span>' . esc_html__('Search Results for', 'pet-rescue') . "</span>: '" . get_search_query() . "'";
		...
		echo '<span>' . esc_html__('No Breadcrumbs', 'pet-rescue') . '</span>';
	}
}
