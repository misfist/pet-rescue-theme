		...
		<div class="cmsms_single_event_header clearfix">
			...
			<div class="cmsms_single_event_header_right clearfix">
				<h6 class="tribe-events-back">
					<a class="cmsms_theme_icon_calendar" href="<?php echo esc_url( tribe_get_events_link() ); ?>"><?php printf( esc_html__( 'All %s', 'the-events-calendar' ), $events_label_plural ); ?></a>
				</h6>
				<?php
	...
	if ($published_events > 1) {
		echo '<aside id="tribe-events-sub-nav" class="post_nav">';		
			echo '<span class="tribe-events-nav-previous cmsms_prev_post">'; 
				...
				echo '<span class="cmsms_wrap_arrow"><span class="cmsms_prev_arrow"><span></span></span></span>';
			echo '</span>';
			
			echo '<span class="tribe-events-nav-next cmsms_next_post">';
				tribe_the_next_event_link('%title%');
				echo '<span class="cmsms_wrap_arrow"><span class="cmsms_next_arrow"><span></span></span></span>';
			echo '</span>';
		echo '</aside>';
	}
